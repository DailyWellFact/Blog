...
const PostPage: NextPage<Props> = ({ post, relatedPosts }) => {
  ...
  // Share URLs (replace with your actual domain)
        ...
        <div style={styles.contentContainer}>
          ...
          <div style={styles.authorBio}>
            ...
            <div style={styles.authorInfo}>
              <h4 style={styles.authorName}>{post.author || 'Daily Well Fact Team'}</h4>
              <p style={styles.authorDesc}>
                Wellness enthusiast sharing science-backed insights to help you live healthier.
              </p>
            </div>
          </div>
